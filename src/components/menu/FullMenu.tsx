...
import { BannerHeader, SectionHeader, FoodCard, FullWidthCard, DrinkCard, ListCard, AddOnBox, Footnote } from './MenuComponents';
...
const FullMenu = () => {
  return <div className="py-12">
      <div className="max-w-2xl mx-auto">
        ...
        return <section key={section.id} id={section.id} className="mb-12 scroll-mt-32">
          ...
          <div className="px-4">
                  {section.items.map(item => <ListCard key={item.title} item={item} />)}
                </div> :

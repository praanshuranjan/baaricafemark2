...
export const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { title: 'Veg Platter', price: '₹719', dietType: 'veg', description: 'honey chilli potato, cheese veggie toast, hakka noodles, peri peri fries, nachos', image: '/menu3/veg platter.png' },
      { title: 'Non Veg Platter', price: '₹839', dietType: 'non-veg', description: 'chicken toast, keema chicken fries, chicken nuggets, chicken noodles, chilli chicken', image: '/menu3/non veg platter.png' },
      { title: 'Continental Platter Veg', price: '₹959', dietType: 'veg', description: 'any pasta, very veggie pizza (three slices), cheesy garlic sandwich, peri peri fries, garlic toast', image: '/menu3/Continental veg platter.png' },
      { title: 'Continental Platter Non Veg', price: '₹1079', dietType: 'non-veg', description: 'any chicken pasta, chicken tikka pizza (three slices), cheesy chicken sandwich, keema fries, chicken toast', image: '/menu3/continental non veg platter.png' },
      { title: 'Non Veg Hummus Platter', price: '₹549', dietType: 'non-veg', description: 'Delight in our exquisite Hummus Platter, a symphony of flavors featuring creamy hummus, warm pita bread, seasoned chickpeas, and zesty peri peri fries', image: '/menu3/non veg hummus platter.png' },
      { title: 'Veg Hummus Platter', price: '₹499', dietType: 'veg', description: 'Grilled paneer, zesty peri peri fries, velvety hummus, and warm pita. A symphony of flavors in every bite!', image: '/menu3/Veg hummus platter.png' },
    ]
  },
  {
    id: 'pizza',
